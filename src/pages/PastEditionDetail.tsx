      ...
      <section ref={mainSectionRef} className="container mx-auto px-4 mb-20 pt-16 relative overflow-hidden">
        <div className={`grid grid-cols-1 ${!activeEvent ? "md:grid-cols-2" : ""} gap-8 mb-8`}>
          ...
          >
            ...
            {/* Floating side polaroids - only visible when May is open */}
            <div
              className={`absolute inset-0 pointer-events-none overflow-hidden transition-opacity duration-500 ${isMayOpen ? "opacity-100" : "opacity-0"}`}
            >
              {/* Left side polaroids */}
              <div
                className={`absolute top-[100px] left-0 w-32 md:w-40 transition-all duration-700 ease-out ${
                  isMayOpen ? "translate-x-[-20%] opacity-70" : "translate-x-[-100%] opacity-0"
                }`}
                style={{
                  transform: isMayOpen ? "translateX(-20%) rotate(-15deg)" : "translateX(-100%) rotate(-15deg)",
                  transitionDelay: "100ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
              ...
              <div
                className={`absolute top-[350px] left-0 w-28 md:w-36 transition-all duration-700 ease-out ${
                  isMayOpen ? "translate-x-[10%] opacity-60" : "translate-x-[-100%] opacity-0"
                }`}
                style={{
                  transform: isMayOpen ? "translateX(10%) rotate(8deg)" : "translateX(-100%) rotate(8deg)",
                  transitionDelay: "250ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
              ...
              <div
                className={`absolute top-[550px] left-0 w-24 md:w-32 transition-all duration-700 ease-out ${
                  isMayOpen ? "translate-x-[-10%] opacity-50" : "translate-x-[-100%] opacity-0"
                }`}
                style={{
                  transform: isMayOpen ? "translateX(-10%) rotate(-5deg)" : "translateX(-100%) rotate(-5deg)",
                  transitionDelay: "400ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
              ...
              <div
                ...
                style={{
                  transform: isMayOpen ? "translateX(20%) rotate(12deg)" : "translateX(100%) rotate(12deg)",
                  transitionDelay: "150ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
              ...
              <div
                className={`absolute top-[400px] right-0 w-28 md:w-36 transition-all duration-700 ease-out ${
                  isMayOpen ? "translate-x-[-5%] opacity-60" : "translate-x-[100%] opacity-0"
                }`}
                style={{
                  transform: isMayOpen ? "translateX(-5%) rotate(-10deg)" : "translateX(100%) rotate(-10deg)",
                  transitionDelay: "300ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
              ...
              <div
                className={`absolute top-[600px] right-0 w-24 md:w-32 transition-all duration-700 ease-out ${
                  isMayOpen ? "translate-x-[15%] opacity-50" : "translate-x-[100%] opacity-0"
                }`}
                style={{
                  transform: isMayOpen ? "translateX(15%) rotate(6deg)" : "translateX(100%) rotate(6deg)",
                  transitionDelay: "450ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
          ...
          >
            ...
            {/* Floating side polaroids - only visible when October is open */}
            <div
              className={`absolute inset-0 pointer-events-none overflow-hidden transition-opacity duration-500 ${isOctoberOpen ? "opacity-100" : "opacity-0"}`}
            >
              {/* Left side polaroids */}
              <div
                className={`absolute top-[100px] left-0 w-32 md:w-40 transition-all duration-700 ease-out ${
                  isOctoberOpen ? "translate-x-[-20%] opacity-70" : "translate-x-[-100%] opacity-0"
                }`}
                style={{
                  transform: isOctoberOpen ? "translateX(-20%) rotate(-15deg)" : "translateX(-100%) rotate(-15deg)",
                  transitionDelay: "100ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
              ...
              <div
                className={`absolute top-[350px] left-0 w-28 md:w-36 transition-all duration-700 ease-out ${
                  isOctoberOpen ? "translate-x-[10%] opacity-60" : "translate-x-[-100%] opacity-0"
                }`}
                style={{
                  transform: isOctoberOpen ? "translateX(10%) rotate(8deg)" : "translateX(-100%) rotate(8deg)",
                  transitionDelay: "250ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
              ...
              <div
                className={`absolute top-[550px] left-0 w-24 md:w-32 transition-all duration-700 ease-out ${
                  isOctoberOpen ? "translate-x-[-10%] opacity-50" : "translate-x-[-100%] opacity-0"
                }`}
                style={{
                  transform: isOctoberOpen ? "translateX(-10%) rotate(-5deg)" : "translateX(-100%) rotate(-5deg)",
                  transitionDelay: "400ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
              ...
              <div
                ...
                style={{
                  transform: isOctoberOpen ? "translateX(20%) rotate(12deg)" : "translateX(100%) rotate(12deg)",
                  transitionDelay: "150ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
              ...
              <div
                className={`absolute top-[400px] right-0 w-28 md:w-36 transition-all duration-700 ease-out ${
                  isOctoberOpen ? "translate-x-[-5%] opacity-60" : "translate-x-[100%] opacity-0"
                }`}
                style={{
                  transform: isOctoberOpen ? "translateX(-5%) rotate(-10deg)" : "translateX(100%) rotate(-10deg)",
                  transitionDelay: "300ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">
              ...
              <div
                className={`absolute top-[600px] right-0 w-24 md:w-32 transition-all duration-700 ease-out ${
                  isOctoberOpen ? "translate-x-[15%] opacity-50" : "translate-x-[100%] opacity-0"
                }`}
                style={{
                  transform: isOctoberOpen ? "translateX(15%) rotate(6deg)" : "translateX(100%) rotate(6deg)",
                  transitionDelay: "450ms",
                }}
              >
                <div className="bg-white p-2 border-2 border-[#000000] shadow-[3px_3px_0px_0px_#000000] rounded-sm">

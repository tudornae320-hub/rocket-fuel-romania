          ...
          <div className="flex-1 max-w-2xl">
            ...
            <div className="space-y-3 mb-6">
              ...
              <button
                ...
                className="rounded-2xl border-2 border-[#000000] bg-card px-6 py-3 shadow-[4px_4px_0px_0px_#000000] text-black font-semibold transition-all duration-150 active:translate-x-[4px] active:translate-y-[4px] active:shadow-[0px_0px_0px_0px_#000000] active:scale-[0.98] my-5"
              >
                Get your ticket
              </button>
